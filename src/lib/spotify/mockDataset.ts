  ...
  return [
    {
      ...
      body: "Between November and February, your sessions after 23:00 nearly tripled. Ambient and Electronic dominated those hours.",
      metric: "+240%",
      tone: "ritual",
    },
    {
      ...
      body: "Twelve consecutive years of presence — one of only six artists with that streak in your library.",
      metric: "12y",
      tone: "evolution",
    },
    {
      id: "3",
      headline: "March 2018 was your Bonobo era.",
      body: "Bonobo accounted for 38% of your minutes that month — your single most concentrated artist obsession on record.",
      metric: "38%",
      tone: "obsession",
    },
    {
      id: "4",
      headline: "You discovered 412 new artists in 2021.",
      body: "Your highest-ever discovery rate. The pandemic-era explorations included Khruangbin, Phoebe Bridgers and Caribou.",
      metric: "412",
      tone: "discovery",
    },
    {
      ...
      body: "73% of your Sunday 08:00–11:00 minutes since 2019 are ambient or modern classical. A clear ritual.",
      metric: "73%",
      tone: "ritual",
    },
    {
      id: "6",
      headline: "Your taste widened by 4 new genres after 2018.",
      body: "Jazz, ambient, soul and hip-hop entered your top-20 only after 2018, suggesting a deliberate curation phase.",
      metric: "+4",
      tone: "evolution",
    },
  ];
